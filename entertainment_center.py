"""
This module centralizes all movies a user wants published on a web page, generates an html with all the movie data, and
...
# Instantiate movie objects with title, storyline, poster art url, and trailer url
devil_wears_prada = media.Movie(
    "The Devil Wears Prada",
    "A young, ambitious journalist makes her career start in NYC, navigating the world of high fashion as the new "
...
dr_strange = media.Movie(
    "Doctor Strange",
    "How an arrogant doctor who lost his ability to heal unlocked his superhero potential",
    "https://vignette.wikia.nocookie.net/marveldatabase/images/a/a0/Doctor_Strange_%28film%29_poster_006.jpg/revision/latest?cb=20160927161946",
    "https://www.youtube.com/watch?v=HSzx-zryEgM")

infernal_affairs = media.Movie(
    "Infernal Affairs",
    "An undercover cop serving as intelligence for Hong Kong's Narcotics Bureau goes against an undercover triad memeber "
    "serving as counter intelligence as an NB officer",
...
easy_a = media.Movie(
    "Easy A",
    "A high school girl finds herself in the middle of a scandal after starting a rumor to help out a friend",
...
good_will_hunting = media.Movie(
    "Good Will Hunting",
    "A gifted mind of a young janitor Will Hunting is given the chance to exercise his genius and to truly find himself along the way",
...
my_movies = [devil_wears_prada, dr_strange, infernal_affairs, stranger_than_fiction, easy_a, good_will_hunting]
